    ...
    extends HttpServlet 
{
    ...
    private static  String         resultTemplateName = "FindAllRentalLocations-Result.ftl";
            ...
            throws ServletException, IOException
    {
        ...
        try {
            ...
            for( int i = 0; i < rv.size(); i++ ) {
                l = (RentalLocation) rv.get( i );
                rentalLocation.add( l.getName() );
                rentalLocation.add( l.getAddress() );
                rentalLocation.add( l.getCapacity() );
